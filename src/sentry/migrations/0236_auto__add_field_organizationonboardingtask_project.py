...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrganizationOnboardingTask.project'
        db.add_column('sentry_organizationonboardingtask', 'project',
                      self.gf('sentry.db.models.fields.foreignkey.FlexibleForeignKey')(to=orm['sentry.Project'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrganizationOnboardingTask.project'
        db.delete_column('sentry_organizationonboardingtask', 'project_id')
    ...
    models = {
        ...
        'sentry.broadcast': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'date_expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 2, 6, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
